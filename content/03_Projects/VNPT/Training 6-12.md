...
Translate: nhận diện tiếng anh, tiếng việt cho đối tác

![[image-263.png]]

![[image-264.png]]

Thực trạng: các case hybrid (onl + off), hoặc off dùng chung một micro. -> Nên cần cải thiện model.

Gợi ý: Sử dụng các thư viện mã nguồn mở, đăng ký voice-print của các thành viên trước khi họp, dùng mutilmodal
